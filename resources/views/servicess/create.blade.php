    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card my-5">
                ...
                <div class="card-body">
                    <form method="POST" class="mt-3" action="{{ route('servicess.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="d_titre" class="form-label fw-bold">Service</label>
                            <input type="text" name="d_titre" value="{{old("d_titre")}}" placeholder="nom service" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="d_titre" class="form-label fw-bold">Devision</label></br>
